      ...
      <div className="relative mx-auto max-w-7xl px-6 py-24 sm:py-32 lg:flex lg:items-center lg:gap-x-10 lg:px-8 lg:py-40">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:flex-auto">
          ...
          <p className="mt-6 text-lg leading-8 text-slate-300">
            Experience the next generation of component libraries. Built with performance, 
            accessibility, and developer experience in mind. Ship faster without compromising on quality.
          </p>
